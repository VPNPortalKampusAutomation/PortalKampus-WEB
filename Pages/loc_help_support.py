...
class LocatorCategory:
    LOC_TITTLE_CATEGORY = (By.XPATH, '//p[@class="MuiTypography-root MuiTypography-title-lg joy-1hipf4c"]')
    LOC_ICON_CATEGORY = (By.XPATH, '//div[@class="HelpCenter_boxIcon__86dv2"]')
    LOC_CARD_CATEGORY = (By.XPATH, '//button[@class="MuiButtonBase-root MuiCardActionArea-root joy-fmtgi3"]')
